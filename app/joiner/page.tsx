...
export default function Joiner() {
  return (
    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '2rem', marginTop:"10%" }}>
      <Title order={1} style={{ margin: '0 0 0.5rem' }}>Audio Joiner</Title>
      <Text size="xl" style={{ margin: '2% 1%' }}>Join multiple audio tracks into one. Choose audio files you want to merge
      </Text>
      <Button 
        variant="outline" 
        color="violet" 
